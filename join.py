...
def react():
    ...
    resp = requests.get(f"https://discord.com/api/v9/channels/{channelID}/messages?limit=50", headers={"authorization": "***REMOVED***"})
    ...
    time.sleep(2)
    requests.put(f"https://discord.com/api/v9/channels/{channelID}/messages/{messageID}/reactions/{emoji['name'] + emoji['id']}/%40me", headers={"authorization": "***REMOVED***"})
